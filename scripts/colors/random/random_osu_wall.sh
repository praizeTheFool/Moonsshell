...
QUICKSHELL_CONFIG_NAME="crescent"
...
crescentshellConfigPath="$HOME/.config/crescentshell/config.json"
currentWallpaperPath=$(jq -r '.background.wallpaperPath' $crescentshellConfigPath)
